...
const PorcinoModel = db.define('porcinos', {
    ...
    Plac_Sena_Porcino: { type: DataTypes.INTEGER, allowNull: false },
    Id_Raza: { type: DataTypes.NUMBER, allowNull: false },
    Gen_Porcino: { type: DataTypes.CHAR ('H', 'M'), allowNull: false },
    Proc_Porcino: { type: DataTypes.CHAR ('Externo', 'Interno'), allowNull: false },
