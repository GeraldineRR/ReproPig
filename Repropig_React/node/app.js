...
PorcinoModel.hasMany(Seguimiento_CerdaModel, { foreignKey: 'Id_Porcino', as: 'seguimiento_cerda_porcino' })
Seguimiento_CerdaModel.belongsTo(PorcinoModel, { foreignKey: 'Id_Porcino', as: 'porcinos' })

MedicamentosModel.hasMany(Seguimiento_CerdaModel, { foreignKey: 'Id_Medicamento', as: 'seguimiento_cerda_medicamento' })
...
// ====== Relaciones Seguimiento Cerda (duplicado comentado) ======
...
CalendarioModel.belongsTo(reproduccionesModel, { foreignKey: 'Id_Reproduccion', as: 'reproducciones' })
reproduccionesModel.hasMany(CalendarioModel, { foreignKey: 'Id_Reproduccion', as: 'calendario' })
app.listen(PORT, () => {
